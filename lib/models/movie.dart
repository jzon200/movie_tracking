class Movie {
  ...
  factory Movie.fromJson(Map<String, dynamic> json) {
    return Movie(
      ...
      synopsis: json['plotOutline']['text'] as String,
  ...
  static List<Movie> fromSnapshot(List snapshot) {
    return snapshot.map((e) => Movie.fromJson(e)).toList();
  }

  @override
  String toString() {
    return 'Movie {id: $id, title: $title, synopsis: $synopsis, imageUrl: $imageUrl, duration: $duration, rating: $rating, year: $year, genres: $genres} ';
  }
